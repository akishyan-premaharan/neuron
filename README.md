...
# The Neuron - My Machine Learning Project

Preview the Neuron's power and the speed of Colab's provided cloud computing

</div>

<br> 

https://github.com/user-attachments/assets/485e7dee-5648-461a-ac84-d52facfa4ece

This project made for learning purposes (Machine Learning & Artifical Intelligence), is a simulation of a neuron that:

- 🎯  Attempts to predict the target value (The number 2)
...
- Run it on a Python environment, such as **VSCode/PyCharm/OneCompiler**

**NOTE:** You should run this code on a cloud hosted IDE if you want multiple epoches, that's what I did

## Tech Stack

| Name | Usage |
|------|-------|
|![Python](https://img.shields.io/badge/python-%233670A0.svg?style=for-the-badge&logo=python&logoColor=ffdd54)| The programming language of the code. |
